(ns de.sveri.shopli.routes.user
  (:require [compojure.core :refer [routes GET POST]]
            ...
            [de.sveri.shopli.views.user :as vh]
            [de.sveri.shopli.views.base :as v]
            [de.sveri.shopli.db.user :as db]
            [de.sveri.shopli.service.auth :as auth]
            [de.sveri.shopli.service.user :as uservice])
