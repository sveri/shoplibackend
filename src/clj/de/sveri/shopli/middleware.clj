(ns de.sveri.shopli.middleware
  (:require [clojure.tools.logging :as log]
            ...
            [de.sveri.shopli.locale :as loc]
            [de.sveri.shopli.service.auth :refer [auth-backend]]
...
(def development-middleware
  [#(prone/wrap-exceptions % {:app-namespaces ['de.sveri.shopli]})
   wrap-reload])
